...
export function buildPaymentReminderMessage(amountLeftFormatted: string, dueDateDDMMYYYY: string): string {
  return [
    ...
    '',
    `Pagesa mund të kryhet : CASH ose në LLOGARINË BANKARE të komunikuar të Club Albania në BKT Bank, duke përcaktuar në përshkrim emrin e sportistes për të cilën bëhet pagesa.`,
    '',
    `Gjithashtu, ju lutemi të na dërgoni një kopje të mandat pagesës në mënyrë elektronike përmes WhatsApp në numrin ${CLUB_WHATSAPP_NUMBER}.`,
    '',
